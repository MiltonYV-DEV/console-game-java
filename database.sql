  enemy_name VADROP SCHEMA  poo_pf;
...
CREATE TABLE battles (
  ...
  CONSTRAINT chk_enemy_ref CHECK (
    (enemy_source='BASE' AND enemy_id IS NOT NULL AND generated_enemy_id IS NULL)
    OR
    (enemy_source='AI' AND generated_enemy_id IS NOT NULL AND enemy_id IS NULL)
  )
);
...
INSERT INTO battles (
  match_id, enemy_source, enemy_id, generated_enemy_id, result,
  turns, damage_dealt, damage_taken
) VALUES
(1, 'AI', NULL, 1, 'WIN',       8, 140, 70),
(2, 'AI', NULL, 2, 'ABANDONED', 3,  35, 20),
(3, 'AI', NULL, 3, 'LOSE',     11, 120, 160),
(4, 'AI', NULL, 4, 'WIN',       6, 115, 55),
(5, 'AI', NULL, 5, 'WIN',      14, 230, 150),
(6, 'AI', NULL, 6, 'LOSE',      9,  98, 130),
(7, 'AI', NULL, 1, 'WIN',       8, 140, 70),
(8, 'AI', NULL, 2, 'ABANDONED', 3,  35, 20),
(9, 'AI', NULL, 3, 'LOSE',     11, 120, 160),
(10, 'AI', NULL, 4, 'WIN',       6, 115, 55),
(11, 'AI', NULL, 5, 'WIN',      14, 230, 150),
(12, 'AI', NULL, 6, 'LOSE',      9,  98, 130),
(13, 'AI', NULL, 1, 'WIN',       8, 140, 70),
(14, 'AI', NULL, 2, 'ABANDONED', 3,  35, 20),
(15, 'AI', NULL, 3, 'LOSE',     11, 120, 160),
(16, 'AI', NULL, 4, 'WIN',       6, 115, 55),
(17, 'AI', NULL, 5, 'WIN',      14, 230, 150),
(18, 'AI', NULL, 6, 'LOSE',      9,  98, 130),
(19, 'AI', NULL, 1, 'WIN',       8, 140, 70),
(20, 'AI', NULL, 2, 'ABANDONED', 3,  35, 20),
(21, 'AI', NULL, 3, 'LOSE',     11, 120, 160),
(22, 'AI', NULL, 4, 'WIN',       6, 115, 55),
(23, 'AI', NULL, 5, 'WIN',      14, 230, 150),
(24, 'AI', NULL, 6, 'LOSE',      9,  98, 130),
(25, 'AI', NULL, 1, 'WIN',       8, 140, 70),
(26, 'AI', NULL, 2, 'ABANDONED', 3,  35, 20),
(27, 'AI', NULL, 3, 'LOSE',     11, 120, 160),
(28, 'AI', NULL, 4, 'WIN',       6, 115, 55);
